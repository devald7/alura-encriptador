window.onload = function(){
  ...
  // Seleccionamos nuestros elementos textarea 
      ...
      const TXT_MENSAJE = document.getElementById("txt_msg");
  ...
  // bloque para aplicar tema oscuro 
      ...
      const BTN_TEMA = document.getElementById("btn_theme"); 
  ...
  // bloque para comprobar si el tema esta activo
      ...
      var TEMA_ACTUAL = localStorage.getItem("theme"); // obtiene el valor para comprobar si activar el tema oscuro
          if(TEMA_ACTUAL == "dark"){
